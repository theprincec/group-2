...
//		}
		...
		public void get_list_of_transfers() {
			long userID = createTestUser("testToUser");
			long recipientID = createTestUser("testFromUser");
			createTestUser("testFromUser");
			BigDecimal amount = BigDecimal.valueOf(150);
			BigDecimal amount1 = BigDecimal.valueOf(250);
			//Transfer test1 = new Transfer();
			//Transfer test2 = new Transfer();
			
			Transfer test1 = dao.addTransfer(userID, recipientID, amount);
			Transfer test2 = dao.addTransfer(userID, recipientID, amount1);
...
//		}
		...
		private long createTestUser(String testName) {
